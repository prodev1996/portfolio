...
export default function SupportDeskGame({
  ...
  useEffect(() => {
    ...
    return () => document.body.classList.remove("native-cursor-active");
  }, [open]);
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="native-cursor-zone fixed inset-0 z-[200] flex items-center justify-center bg-black/70 p-4 backdrop-blur-md"
        onClick={onClose}
      >
        <motion.div
